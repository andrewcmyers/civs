...
sub opted_out { # addr
  "क्षमा करें, आप &lt;$_[1]&gt; CIVS के माध्यम से।"
}
...
sub Results_key_email_body { # title, url, civs_home
  "\"$_[1]\" नाम से एक नया CIVS पोल बनाया गया है। आपको एक ऐसे उपयोगकर्ता के रूप में नामित किया गया है जिसे इस पोल का परिणाम देखने की अनुमति है।
...
sub Too_much_email {
  'क्षमा करें, CIVS ने ईमेल उत्पन्न करने की संख्या को सीमित कर दिया है। कृपया बाद में और मतदाता जोड़ें।'
}
...
sub Activate_mail_subject {
  'कृपया CIVS पर अपना ईमेल पता सक्रिय करें'
}
sub Address {
  'पता'
}
...
sub Activate_mail_body {
 ...
 मतदान करने के लिए, कृपया CIVS मतदान प्रणाली के साथ अपना ईमेल पता सक्रिय करें: <$url>"
}
...
sub Address_opted_out { # addr
  "यह पता CIVS ईमेल से बाहर हो गया है: $_[1]"
}
sub Sending_mail_to_voter_v {
  "मतदाता को मेल भेजना \"$_[1]\"..."
}
sub CIVS_poll_supervisor { # name
  "\"Condorcet इंटरनेट वोटिंग सेवा ($_[1] की ओर से)\""
}
...
sub for_more_information_about_CIVS { # url
  "Condorcet इंटरनेट वोटिंग सेवा के बारे में अधिक जानकारी के लिए, देखें $_[1]"
}
...
sub Condorcet_winner_explanation {
  '&nbsp;&nbsp;(Condorcet विजेता: अन्य सभी विकल्पों के साथ प्रतियोगिता जीतता है)'
}
...
sub cant_send_email {
  'आप CIVS का उपयोग कर इस उपयोगकर्ता को ईमेल नहीं भेज सकते। इस उपयोगकर्ता को भेजे गए ईमेल को पहले भेजे गए निष्क्रियकरण कोड का उपयोग करके पहले पुनः सक्रिय किया जाना चाहिए।'
}
sub submit_deact_react {
  'निष्क्रियता / पुनर्सक्रियन जमा करें'
}
sub codes_dont_match {
  "क्षमा करें, दिया गया कोड और ईमेल पता मेल नहीं खाते। यदि आपने पहले CIVS से ईमेल अवरुद्ध नहीं किया है तो आप दूसरे कोड का अनुरोध कर सकते हैं।"
}
sub deactivation_successful {
    my ($self, $pattern) = @_;
  "यदि CIVS इस पते पर कोई और मेल नहीं भेजेगा यदि इसका प्रेषक इस पैटर्न से मेल खाता है: \"$पैटर्न\"। आप केवल इस वेब पेज का उपयोग करके उसी कोड के साथ CIVS से मेल को पुनः सक्रिय कर सकते हैं जिसका आपने अभी उपयोग किया है।"
}
sub reactivation_successful {
  'आपने इस पते पर मेल को सफलतापूर्वक पुनः सक्रिय कर दिया है।'
}
sub someone_has_requested {
  "किसी ने CIVS को आपको ईमेल भेजने से रोकने के लिए एक कोड का अनुरोध किया है। यदि यह आप थे, तो आपको पता चल जाएगा कि इसके साथ क्या करना है। कोड है:
 $_[1]
...
sub someone_has_requested_activation {
  ...
  "किसी ने अनुरोध किया है कि CIVS वोटिंग सिस्टम मतदान में मतदान के लिए ईमेल पता <$address> सक्रिय करें। इस पते को सक्रिय करने के लिए, आपको निम्नलिखित सक्रियण कोड की आवश्यकता होगी:
 $ कोड
